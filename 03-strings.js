...
console.log(s1.substr(7,10));   //  ->  deprecated(폐지예정, 가급적 사용x (브라우져 호환성 때문에 남겨놓음))
console.log(s1.substring(7,17));    //  인덱스 7 부터 17앞까지
...
pos = s1.lastIndexOf("Script");     //  뒤에서부터 앞으로 검색
