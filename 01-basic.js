...
// 콘술 출력은 전역 객체 console의 출력 메서드 사용
...
console.log("Process Architercture:", process.arch);
...
// TEST_CONST = "const changed";   ->  ERROR: const는 
...
// 데이터 타입을 확인하고자 할 때, typeof 키워드로 확인 가능
